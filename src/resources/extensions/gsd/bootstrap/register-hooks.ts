    ...
    ctx.ui.setHeader((_tui, theme) => {
      ...
      return {
        render(width: number): string[] {
          ...
          const thinkingLevel = typeof ctx.getThinkingLevel === "function" ? ctx.getThinkingLevel() : undefined;
          const cacheKey = JSON.stringify([modelName, provider, authMode, thinkingLevel, remoteChannel]);
          if (cachedLines !== undefined && cachedWidth === width && cachedKey === cacheKey) return cachedLines;
          cachedLines = welcome.buildWelcomeScreenLines({
            ...
            authMode,
            thinkingLevel,
            logoColorAnsi: typeof theme.getFgAnsi === "function" ? theme.getFgAnsi("logo") : undefined,
          });
          cachedWidth = width;
          cachedKey = cacheKey;
          return cachedLines;
