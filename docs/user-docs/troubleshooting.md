...
**Symptoms:** `npm install -g gsd-revamp@latest` succeeds but `gsd` isn't found.
...
**Workaround:** Run `npx gsd-revamp@latest` or `$(npm prefix -g)/bin/gsd` directly.
...
### `npm install -g gsd-revamp@latest` fails
...
- **GitHub Issues:** [github.com/qdzsh/gsd-revamp/issues](https://github.com/qdzsh/gsd-revamp/issues)
