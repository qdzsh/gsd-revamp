...
const NPM_PACKAGE_NAME = 'gsd-revamp'
const CHECK_INTERVAL_MS = 24 * 60 * 60 * 1000 // 24 hours
const FETCH_TIMEOUT_MS = 5000
const DEFAULT_REGISTRY_URL = `https://registry.npmjs.org/gsd-revamp/latest`
...
function printUpdateBanner(current: string, latest: string): void {
  const installCmd = resolveInstallCommand('gsd-revamp@latest')
