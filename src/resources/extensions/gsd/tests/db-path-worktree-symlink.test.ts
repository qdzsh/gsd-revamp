...
const projectRoot = sep === "\\" ? "C:\\home\\user\\myproject" : "/home/user/myproject";

// Standard worktree layout (already works)
const standardPath = join(projectRoot, ".gsd", "worktrees", "M001", "work");
...
const symlinkPath = join(projectRoot, ".gsd", "projects", "abc123def", "worktrees", "M001", "work");
const symlinkResult = resolveProjectRootDbPath(symlinkPath);
assertEq(
  symlinkResult,
  join(projectRoot, ".gsd", "projects", "abc123def", "gsd.db"),
