...
Public protocol types are shared through `@gsd-revamp/contracts` and re-exported from this package for compatibility.

## Installation

```bash
npm install @gsd-revamp/rpc-client
```

## Quick Start

```typescript
import { RpcClient } from '@gsd-revamp/rpc-client';
