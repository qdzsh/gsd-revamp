...
// GSD_PKG_ROOT — absolute path to gsd-revamp package root. Used by deployed extensions
...
if (missingPackages.length > 0) {
  ...
  process.stderr.write(
    ...
    `  · An outdated version installed from npm (run: npm install -g gsd-revamp@latest)\n` +
    ...
    `  https://github.com/qdzsh/gsd-revamp/issues\n`
  )
  process.exit(1)
}
