...
test("formatPostUnitStatusCard renders verification metadata without a frame", () => {
...
test("formatConnectedStepStack renders task completion as an unframed receipt", () => {
