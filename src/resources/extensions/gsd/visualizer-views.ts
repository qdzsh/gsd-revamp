...
import { formatDisplayModel, formatDuration, padRight, joinColumns, sparkline, STATUS_GLYPH, STATUS_COLOR } from "../shared/mod.js";
...
function shortenModel(model: string): string {
  return formatDisplayModel(model).replace(/^claude-/, "").slice(0, 12);
}
